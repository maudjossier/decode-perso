...
popover =  <Link to='/login'><img src='user.svg' alt='heart icon' className='NavBarIcon'/></Link>
}
    ...
    <div style={{ scrollBehavior: "smooth" }}> 
      ...
      <Link style={{textDecoration:"none"}} to="/">
        ...
        <div id="section1" className="imageBackground" >
          ...
          <p  id='pHome' data-mdb-toggle="animation" data-mdb-animation-reset="true" data-mdb-animation="fade-in-down">DÉCOUVREZ L'INTÉRIEUR DONT 
          VOUS AVEZ TOUJOURS RÊVÉ</p>
